...
package com.watch.project.commentsendpoint;

/**
 * Service definition for Commentsendpoint (v1).
 *
 * <p>
 * This is an API
 * </p>
...
public class Commentsendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.17.0-rc of the commentsendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "commentsendpoint/v1/";
  ...
  public class GetComments extends CommentsendpointRequest<com.watch.project.commentsendpoint.model.Comments> {
    ...
    protected GetComments(java.lang.Long id) {
      super(Commentsendpoint.this, "GET", REST_PATH, null, com.watch.project.commentsendpoint.model.Comments.class);
   ...
   * operation.
   *
   * @param content the {@link com.watch.project.commentsendpoint.model.Comments}
   * @return the request
   */
  public InsertComments insertComments(com.watch.project.commentsendpoint.model.Comments content) throws java.io.IOException {
    InsertComments result = new InsertComments(content);
    initialize(result);
    return result;
  }

  public class InsertComments extends CommentsendpointRequest<com.watch.project.commentsendpoint.model.Comments> {
     ...
     * @since 1.13
     */
    protected InsertComments(com.watch.project.commentsendpoint.model.Comments content) {
      super(Commentsendpoint.this, "POST", REST_PATH, content, com.watch.project.commentsendpoint.model.Comments.class);
    }
  ...
  public class ListComments extends CommentsendpointRequest<com.watch.project.commentsendpoint.model.CollectionResponseComments> {
    ...
    protected ListComments() {
      super(Commentsendpoint.this, "GET", REST_PATH, null, com.watch.project.commentsendpoint.model.CollectionResponseComments.class);
    }
  ...
  public class RemoveComments extends CommentsendpointRequest<com.watch.project.commentsendpoint.model.Comments> {
    ...
    protected RemoveComments(java.lang.Long id) {
      super(Commentsendpoint.this, "DELETE", REST_PATH, null, com.watch.project.commentsendpoint.model.Comments.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateComments updateComments(com.watch.project.commentsendpoint.model.Comments content) throws java.io.IOException {
    UpdateComments result = new UpdateComments(content);
    initialize(result);
    return result;
  }

  public class UpdateComments extends CommentsendpointRequest<com.watch.project.commentsendpoint.model.Comments> {
     ...
     * @since 1.13
     */
    protected UpdateComments(com.watch.project.commentsendpoint.model.Comments content) {
      super(Commentsendpoint.this, "PUT", REST_PATH, content, com.watch.project.commentsendpoint.model.Comments.class);
    }
